...
public abstract class SpigetClient {
    ...
    public static Function<String, SpigetResponse> GET_OVERRIDE;
    public static Function<String, SpigetDownload> DOWNLOAD_OVERRIDE;
    ...
    public static SpigetResponse get(String url) throws IOException, InterruptedException {
        if (GET_OVERRIDE != null) {
            return GET_OVERRIDE.apply(url);
        }
